          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-9 h-9 rounded-lg bg-[#25D366]/10 border border-[#25D366]/20 flex items-center justify-center hover:bg-[#25D366]/20 transition-colors"
              >
              ...
              <a
                ...
                className="w-9 h-9 rounded-lg bg-[#1877F2]/10 border border-[#1877F2]/20 flex items-center justify-center hover:bg-[#1877F2]/20 transition-colors"
              >
              ...
              <a
                href="#"
                aria-label="AgriLens AI on LinkedIn"
